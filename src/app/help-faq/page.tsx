          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-muted-foreground space-y-2">
                <p>DUE PROCESS AI is the first tool of its kind designed to give power back to the people in the courtroom. It aims to make legal concepts more accessible and can assist in identifying and exposing potential government abuse or official misconduct. It helps users understand their rights and charges. Its purpose is to replace fear, confusion, and powerlessness with clarity, confidence, and control for those navigating the legal system.</p>
                <p>This app is especially vital for those who have: been falsely accused or charged; experienced official retaliation; been denied access to justice; or lost trust in public defenders. It is also particularly useful for: Pro Se litigants (people representing themselves without lawyers); victims of police misconduct, selective prosecution, or other forms of public official misconduct; civil rights activists and advocates; paralegals seeking tools for case preparation; individuals in rural areas, tribal jurisdictions, or underserved communities with limited access to legal professionals; families seeking justice or clarity for incarcerated or persecuted loved ones; and anyone preparing to file lawsuits or make requests under statutes such as 42 U.S.C. § 1983 (Civil Rights), Freedom of Information Act (FOIA), Americans with Disabilities Act (ADA), etc.</p>
            ...
            <AccordionItem value="item-advanced-ai-concepts">
                ...
                <AccordionContent className="text-muted-foreground space-y-3">
                    ...
                    <div>
                        <h4 className="font-semibold text-foreground/90">Smart Form Filler (AI-Powered & Conceptual)</h4>
                        <p>A future AI could extract relevant data from your case summary, uploaded documents (with OCR), or direct inputs, and use it to intelligently populate court form templates. It might also suggest appropriate legal phrasing or clause insertions for custom documents.</p>
                    </div>

                    <div>
                        <h4 className="font-semibold text-foreground/90">Evidence-to-Complaint Generation (Conceptual)</h4>
                        <p>A highly advanced concept where the AI assists in drafting an initial complaint by analyzing compiled evidence and case details to suggest factual allegations and potential causes of action.</p>
                    </div>
