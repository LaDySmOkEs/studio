          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-muted-foreground space-y-2">
                <p>DUE PROCESS AI is the first tool of its kind designed to give power back to the people in the courtroom. It aims to make legal concepts more accessible and can assist in identifying and exposing potential government abuse or official misconduct. Its purpose is to replace fear, confusion, and powerlessness with clarity, confidence, and control for those navigating the legal system.</p>
