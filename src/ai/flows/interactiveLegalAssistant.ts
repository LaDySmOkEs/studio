...
import { 
  ...
  InteractiveAssistantOutputSchema, 
  type InteractiveAssistantOutput 
} from '@/ai/schemas/interactiveAssistantSchemas';

// Re-export types for convenience if actions or pages import them from here
export type { InteractiveAssistantInput, InteractiveAssistantOutput };
